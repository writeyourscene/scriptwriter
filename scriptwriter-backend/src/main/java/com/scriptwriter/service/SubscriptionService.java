...
public interface SubscriptionService {
    ...
    com.scriptwriter.entity.SubscriptionConfig updateConfig(int monthlyPriceRupees, int yearlyPriceRupees, int monthlyDiscountPercent, int yearlyDiscountPercent);
}
